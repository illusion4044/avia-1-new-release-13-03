...
namespace Avia1
{
    public partial class BookTicket : Window
    {
        ...
        public BookTicket(ObservableCollection<Ticket> ticketCollection, MainWindow mainWindow)
        {
            ...
            destinationComboBox.ItemsSource = new string[] { "Київ", "Львів", "Харків", "Одеса", "Біла Церква" };
        ...
        private void BookTicket_Click(object sender, RoutedEventArgs e)
        {
            ...
            Ticket newTicket = new Ticket
            {
                ...
                TripType = tripTypeComboBox.SelectedItem.ToString(),
                Class = classComboBox.SelectedItem.ToString(),
                FullName = fullNameTextBox.Text,
                Email = emailTextBox.Text,
                OrderTime = DateTime.Now // Додаємо час замовлення
            };
